...
public class erratique extends beta {
	...
	public void deplacer(){
		...
		if((h==0)||(w==0)){a1=0;}
		if(h==0){a2=0;}
		if((h==0)||(w==l.taille-1)){a3=0;}
		if(w==0){a4=0;}
		if(w==l.taille-1){a5=0;}
		if((h==l.taille-1)||(w==0)){a6=0;}
		if(h==l.taille-1){a7=0;}
		if((h==l.taille-1)||(w==l.taille-1)){a1=0;}
		if(a1!=0){a1=this.accessible(h-1,w-1);}
		if(a2!=0){a1=this.accessible(h-1,w);}
		if(a3!=0){a1=this.accessible(h-1,w+1);}
		if(a4!=0){a1=this.accessible(h,w-1);}
		if(a5!=0){a1=this.accessible(h,w+1);}
		if(a6!=0){a1=this.accessible(h+1,w-1);}
		if(a7!=0){a1=this.accessible(h+1,w);}
		if(a8!=0){a1=this.accessible(h+1,w+1);}
